...
echo "check if all data files exists"
...
do
	...
	/spark/bin/spark-submit --class $gc --master spark://spark-master:7077 /home/graphx-application/target/scala-2.11/graphx-application-assembly-1.0.jar "/tmp/$data" --data /tmp/100k.txt --workload 5 --mm 64 --mc 8 --wn 3 --wmpn 64 --wcpn 8
        echo "running ocdetection app in standalone mode"
	/spark/bin/spark-submit --class $ocd --master spark://spark-master:7077 /home/graphx-application/target/scala-2.11/graphx-application-assembly-1.0.jar "/tmp/$data" --data /tmp/$data --workload 5 --mm 64 --mc 8 --wn 3 --wmpn 64 --wcpn 8
        echo "running rgdetection app in standalone mode"
	/spark/bin/spark-submit --class $rgd --master spark://spark-master:7077 /home/mapreduce-experiment/target/mapreduce-experiment-1.0-SNAPSHOT.jar "/tmp/$data" --data /tmp/$data --workload 5 --mm 64 --mc 8 --wn 3 --wmpn 64 --wcpn 8
